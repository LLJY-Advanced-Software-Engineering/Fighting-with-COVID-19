...
//Containen for displaying the corona detaies
let coronaDetailsContainer;

// Dropdown for country selection
let countrySelectDropdown;

// Cotainen for rendering the world corona details
...
function renderMap() {
	mapboxgl.accessToken = 'pk.eyJ1IjoiZXppcm9tZW0iLCJhIjoiY2tpMmJxZXd6MHRucDJybXNmMGJ3ZnNmNiJ9.r3nXrQbqnHlRHZfs9f5CUQ';
		...
		map.addSource('places', {
			...
			data: {
				...
				crs: {
					type: 'name',
					properties: {
						name: 'urn:orgc:def:crs:OGC:1.3:CRS84',
					},
				},
...
async function performAsynCall() {
...
function renderUI(details, world = false) {
	...
	<thead>
	${
		world ? '<h1>COVID-19 World Details</h1>' : `
